...
namespace TH.DEmo.LanguageDetection
{
    public class LanguageDetector
    {
        ...
        private const string ResourceNamePrefix = "TH.DEmo.LanguageDetection.Profiles.";
        ...
        public void AddLanguages(params string[] languages)
        {
            ...
            {
                string file = ResourceNamePrefix + language;// + ".bin.gz";
                string file2 = @"E:\Solution\Source Code\VCPMC_masterListDataReport\TH_solution\TH.DEmo.LanguageDetection\Profiles\vi";
                //string filepath = "/home/data/data.txt";
                using (var stream = new FileStream(path: file2, mode: FileMode.Open, access: FileAccess.Read, share: FileShare.Read))
                {
                ...
                //Stream stream1 = assembly.GetManifestResourceStream(file);
                //Stream decompressedStream1 = new GZipStream(stream1, CompressionMode.Decompress);

                //using (Stream stream = assembly.GetManifestResourceStream(ResourceNamePrefix))
