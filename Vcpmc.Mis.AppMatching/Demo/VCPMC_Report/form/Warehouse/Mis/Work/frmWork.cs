    ...
    public partial class frmWork : Form
    {
        ...
        private async void LoadData(int PageIndex)
        {
            try
            {
                ...
                statusMain.Invoke(new MethodInvoker(delegate
                {
                    lbOperation.Text = "Search data is finish";
                }));
                isRequest = false;
            }
            catch (Exception)
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                request.ISRC = txtISRC.Text.Trim().ToUpper();
                request.WRITER = txtWRITER.Text.Trim().ToUpper();
                request.ARTIST = txtARTIST.Text.Trim().ToUpper();
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                frmWorkUpdate frm = new frmWorkUpdate(controller, UpdataType.Edit, CurrenObject);
                frm.ShowDialog();
                if (frm.ObjectReturn != null && frm.ObjectReturn.Status == Utilities.Common.UpdateStatus.Successfull)
                {
        ...
        private void btnImport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                frmWorkImport frm = new frmWorkImport(controller);
                frm.ShowDialog();
            }
            catch (Exception)
            {
        ...
        private void btnExportVcpmc_Click(object sender, EventArgs e)
        {
            try
            {
                if (isRequest)
