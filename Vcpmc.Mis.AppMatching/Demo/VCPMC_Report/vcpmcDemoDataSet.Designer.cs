...
namespace Vcpmc.Mis.AppMatching {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("vcpmcDemoDataSet")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class vcpmcDemoDataSet : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        protected vcpmcDemoDataSet(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            vcpmcDemoDataSet cln = ((vcpmcDemoDataSet)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "vcpmcDemoDataSet";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/vcpmcDemoDataSet.xsd";
        ...
        public static global::System.Xml.Schema.XmlSchemaComplexType GetTypedDataSetSchema(global::System.Xml.Schema.XmlSchemaSet xs) {
            vcpmcDemoDataSet ds = new vcpmcDemoDataSet();
...
namespace Vcpmc.Mis.AppMatching.vcpmcDemoDataSetTableAdapters {
    ...
    public partial class DistributionDataItemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[DistributionDataItems] ([Id], [TimeCreate], [StatusLoad], [DistributionDataId], [No], [WorkInNo], [Title], [Title2], [PoolName], [PoolName2], [SourceName], [SourceName2], [Role], [Share], [Royalty], [Location], [strContractTime], [ContractTime], [TotalAuthor], [IsMapAuthor], [BhAuthor], [IsCondittionTime], [SubMember], [Beneficiary], [GetPart], [IsAlwaysGet], [IsMapByGroup], [returnDate], [Percent], [IsGiveBeneficiary], [IsExcept], [IsCreateReport], [Note], [Note2]) VALUES (@Id, @TimeCreate, @StatusLoad, @DistributionDataId, @No, @WorkInNo, @Title, @Title2, @PoolName, @PoolName2, @SourceName, @SourceName2, @Role, @Share, @Royalty, @Location, @strContractTime, @ContractTime, @TotalAuthor, @IsMapAuthor, @BhAuthor, @IsCondittionTime, @SubMember, @Beneficiary, @GetPart, @IsAlwaysGet, @IsMapByGroup, @returnDate, @Percent, @IsGiveBeneficiary, @IsExcept, @IsCreateReport, @Note, @Note2);
SELECT Id, TimeCreate, StatusLoad, DistributionDataId, No, WorkInNo, Title, Title2, PoolName, PoolName2, SourceName, SourceName2, Role, Share, Royalty, Location, strContractTime, ContractTime, TotalAuthor, IsMapAuthor, BhAuthor, IsCondittionTime, SubMember, Beneficiary, GetPart, IsAlwaysGet, IsMapByGroup, returnDate, [Percent], IsGiveBeneficiary, IsExcept, IsCreateReport, Note, Note2 FROM DistributionDataItems WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[DistributionDataItems] SET [Id] = @Id, [TimeCreate] = @TimeCreate, " +
                ...
                " = @IsCreateReport, [Note] = @Note, [Note2] = @Note2 WHERE (([Id] = @Original_Id" +
                ") AND ([TimeCreate] = @Original_TimeCreate) AND ([StatusLoad] = @Original_Status" +
                "Load) AND ([DistributionDataId] = @Original_DistributionDataId) AND ([No] = @Ori" +
                "ginal_No) AND ([Share] = @Original_Share) AND ([Royalty] = @Original_Royalty) AN" +
                "D ([ContractTime] = @Original_ContractTime) AND ([IsMapAuthor] = @Original_IsMap" +
                "Author) AND ([IsCondittionTime] = @Original_IsCondittionTime) AND ([IsAlwaysGet]" +
                " = @Original_IsAlwaysGet) AND ([IsMapByGroup] = @Original_IsMapByGroup) AND ((@I" +
                "sNull_returnDate = 1 AND [returnDate] IS NULL) OR ([returnDate] = @Original_retu" +
                "rnDate)) AND ([Percent] = @Original_Percent) AND ([IsGiveBeneficiary] = @Origina" +
                "l_IsGiveBeneficiary) AND ([IsExcept] = @Original_IsExcept) AND ([IsCreateReport]" +
                " = @Original_IsCreateReport));\r\nSELECT Id, TimeCreate, StatusLoad, DistributionD" +
                "ataId, No, WorkInNo, Title, Title2, PoolName, PoolName2, SourceName, SourceName2" +
                ", Role, Share, Royalty, Location, strContractTime, ContractTime, TotalAuthor, Is" +
                "MapAuthor, BhAuthor, IsCondittionTime, SubMember, Beneficiary, GetPart, IsAlways" +
                "Get, IsMapByGroup, returnDate, [Percent], IsGiveBeneficiary, IsExcept, IsCreateR" +
                "eport, Note, Note2 FROM DistributionDataItems WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=DESKTOP-T0K91DM\\SQLEXPRESS;Initial Catalog=vcpmcDemo;Integrated Secur" +
                "ity=True";
        }
        ...
        public virtual int Fill(vcpmcDemoDataSet.DistributionDataItemsDataTable dataTable) {
        ...
        public virtual vcpmcDemoDataSet.DistributionDataItemsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            vcpmcDemoDataSet.DistributionDataItemsDataTable dataTable = new vcpmcDemoDataSet.DistributionDataItemsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(vcpmcDemoDataSet.DistributionDataItemsDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(vcpmcDemoDataSet dataSet) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[35].Value = ((System.DateTime)(Original_TimeCreate));
            this.Adapter.UpdateCommand.Parameters[36].Value = ((bool)(Original_StatusLoad));
            this.Adapter.UpdateCommand.Parameters[37].Value = ((System.Guid)(Original_DistributionDataId));
            this.Adapter.UpdateCommand.Parameters[38].Value = ((int)(Original_No));
            this.Adapter.UpdateCommand.Parameters[39].Value = ((decimal)(Original_Share));
            this.Adapter.UpdateCommand.Parameters[40].Value = ((decimal)(Original_Royalty));
            this.Adapter.UpdateCommand.Parameters[41].Value = ((System.DateTime)(Original_ContractTime));
            this.Adapter.UpdateCommand.Parameters[42].Value = ((bool)(Original_IsMapAuthor));
            this.Adapter.UpdateCommand.Parameters[43].Value = ((bool)(Original_IsCondittionTime));
            this.Adapter.UpdateCommand.Parameters[44].Value = ((bool)(Original_IsAlwaysGet));
            this.Adapter.UpdateCommand.Parameters[45].Value = ((bool)(Original_IsMapByGroup));
            if ((Original_returnDate.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[46].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[47].Value = ((System.DateTime)(Original_returnDate.Value));
            }
            else {
                this.Adapter.UpdateCommand.Parameters[46].Value = ((object)(1));
                this.Adapter.UpdateCommand.Parameters[47].Value = global::System.DBNull.Value;
            }
            this.Adapter.UpdateCommand.Parameters[48].Value = ((decimal)(Original_Percent));
            this.Adapter.UpdateCommand.Parameters[49].Value = ((bool)(Original_IsGiveBeneficiary));
            this.Adapter.UpdateCommand.Parameters[50].Value = ((bool)(Original_IsExcept));
            this.Adapter.UpdateCommand.Parameters[51].Value = ((bool)(Original_IsCreateReport));
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateUpdatedRows(vcpmcDemoDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._distributionDataItemsTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateInsertedRows(vcpmcDemoDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._distributionDataItemsTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateDeletedRows(vcpmcDemoDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._distributionDataItemsTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        public virtual int UpdateAll(vcpmcDemoDataSet dataSet) {
            if ((dataSet == null)) {
