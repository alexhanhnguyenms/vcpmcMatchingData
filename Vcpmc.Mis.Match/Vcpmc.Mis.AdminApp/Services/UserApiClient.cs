...
namespace Vcpmc.Mis.AdminApp.Services
{
    public class UserApiClient : IUserApiClient
    {
        ...
        public Task<ApiResult<UserViewModel>> GetById(string id)
        {
        ...
        public Task<ApiResult<bool>> RegisterUser(UserCreateRequest registerRequest)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<ApiResult<bool>> UpdateUser(UserUpdateRequest request)
        {
            throw new NotImplementedException();
        }
    }
