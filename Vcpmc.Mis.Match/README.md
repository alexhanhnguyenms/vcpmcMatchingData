...
- Set startup project is Vcpmc.Mis.Data
- Change connection string in Appsetting.json in Vcpmc.Mis.Data project
- Open Tools --> Nuget Package Manager -->  Package Manager Console in Visual Studio
- Run Update-database and Enter.
- After migrate database successful, set Startup Project is Vcpmc.Mis.WebApp
- Change database connection in appsettings.Development.json in Vcpmc.Mis.WebApp project.
